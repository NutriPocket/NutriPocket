...
const validationSchema = Yup.object().shape({
    ...
    end_hour: Yup.number()
        ...
        .test("end-greater-than-start", "La hora de fin debe ser posterior a la de inicio",
            function (value) {
...
export default function AddRoutineScreen() {
    ...
    const handleSubmit = async (values: any) => {
        ...
        try {
            ...
            Alert.alert(
                "Rutina creada",
                "La rutina se ha agregado exitosamente",
                [
                    {
                        text: "OK",
                        onPress: () => router.back(),
                                ...
                                <Menu
                                    ...
                                    anchor={
                                        <TextInput
                                            ...
                                            value={dayOptions.find(d => d.value === values.day)?.label || ""}
                            ...
                            <View style={styles.timeContainer}>
                                <View style={styles.timeInput}>
                                    <TextInput
                                        ...
                                        onChangeText={handleChange("start_hour")}
                                ...
                                <View style={styles.timeInput}>
                                    <TextInput
                                        ...
                                        onChangeText={handleChange("end_hour")}
                                        onBlur={handleBlur("end_hour")}
                                        mode="outlined"
                                        activeOutlineColor="#287D76"
                                        keyboardType="numeric"
                                        error={touched.end_hour && !!errors.end_hour}
                                        style={styles.input}
                                    />
                                    {touched.end_hour && errors.end_hour && (
                                        <Text style={styles.errorText}>{errors.end_hour}</Text>
                                    )}
                                </View>
                            </View>
